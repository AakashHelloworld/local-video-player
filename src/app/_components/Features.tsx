...
export default function Feature() {
    ...
    <div className='flex justify-center mt-[5rem] sm:mt-[10rem]'>
      <div className="flex flex-col w-[100%]  rounded p-4 justify-center items-start">
        <div className="mb-8">
    <motion.h1 initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: .5, delay: .2 }} className='text-[1.8rem] sm:text-[4rem] text-white font-bebas_Neue inline'>Smart <span className="text-[#818cf8]">Features</span></motion.h1>
    <motion.p initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: .5 , delay: .5}} className="text-white text-[12px] sm:text-[16px]  font-poppins text-opacity-70	">The platform offers a range of features that make it easy for users to enjoy their local videos.</motion.p>
    </div>
        
          <div className="flex flex-col gap-3 sm:grid sm:grid-cols-10 sm:grid-rows-6 sm:gap-5 sm:h-[60rem] sm:w-[80rem] mt-2 sm:mt-8"> 
             
             
          <div className="sm:col-span-6 sm:row-span-2 bg-gradient-to-br from-slate-900 to-slate-700 rounded-lg p-4  bg-opacity-30">
              <div className="w-full sm:h-full bg-transparent sm:mt-[2rem]">
                ...
                <div className="mt-8">
                  <h3 className="text-white font-poppins text-[12px] sm:text-[1.1rem] text-opacity-70 line-clamp-3">
              ...
              <div className="w-full h-full bg-transparent sm:mt-[2rem] ">
                    <div className="flex gap-2 sm:gap-4 items-center">
                      <span className=" w-9 h-9 sm:w-12 sm:h-12 bg-gradient-to-br from-[#818cf8] to-[#0b0d15] rounded-full flex justify-center items-center">
                      ...
                      <div className="mt-8">
                        <p className="text-white font-poppins text-[12px] sm:text-[1.1rem] text-opacity-70 line-clamp-3">A directory of local videos can be selected, making it easy to browse and choose videos for viewing.</p>
                      </div>
                </div>
              ...
              <div className="w-full h-full bg-transparent sm:mt-[2rem] ">
                    <div className="flex gap-4 items-center">
                      ...
                      <div className="mt-8">
                        <p className="text-white font-poppins text-[12px] sm:text-[1.1rem] text-opacity-70 line-clamp-3">Completion badges are earned upon finishing videos, adding a sense of accomplishment to the viewing experience.</p>
                      </div>
                </div>
              ...
              <div className="w-full bg-transparent sm:mt-[2rem] ">
                    <div className="flex gap-4 items-center">
                      <span className=" w-9 h-9 sm:w-12 sm:h-12 bg-gradient-to-br from-[#818cf8] to-[#0b0d15] rounded-full flex justify-center items-center">
                      ...
                      <div className="mt-8">
                        <p className="text-white font-poppins text-[12px] sm:text-[1.1rem] text-opacity-70 line-clamp-3">After selecting a theme and directory, a customized interface displays the video list. Features like auto-skip and auto-play make the viewing experience seamless and enjoyable.</p>
                      </div>
                </div>
              ...
              <div className="w-full h-full bg-transparent sm:mt-[2rem] ">
                    <div className="flex gap-4 items-center">
                      ...
                      <div className="mt-8 sm:w-3/4">
                        <p className="text-white font-poppins text-[12px] sm:text-[1.1rem] text-opacity-70 line-clamp-3">Notes can be added beneath each video to track important points or ideas, especially for educational or project-based content. At the end of the session, a PDF of all notes can be downloaded, ensuring insights are saved for future reference.</p>
                      </div>
                </div>
