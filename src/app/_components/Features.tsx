...
export default function Feature() {
  return (
    <div className="flex justify-center mt-[5rem] sm:mt-[10rem] px-4 lg:px-8">
        ...
        <div className="flex flex-col gap-3 sm:grid sm:grid-cols-10 sm:grid-rows-6 sm:gap-5 lg:h-[50rem] xl:h-[60rem] lg:w-[70rem] xl:w-[80rem] mt-2 sm:mt-8">
          ...
          <div className="sm:col-span-6 sm:row-span-2 bg-gradient-to-br from-slate-900 to-slate-700 rounded-lg p-4 bg-opacity-30">
            <div className="w-full sm:h-full">
              ...
              <div className="mt-4 lg:mt-8">
                <h3 className="text-white font-poppins text-[12px] sm:text-[1.1rem] lg:text-[1.2rem] text-opacity-70 line-clamp-3">
          ...
          <div className="col-span-4 row-span-2 col-start-7 bg-gradient-to-bl from-slate-900 to-slate-700 rounded-lg bg-opacity-70 p-4">
            <div className="w-full h-full">
              ...
              <div className="mt-4 lg:mt-8">
                <p className="text-white font-poppins text-[12px] sm:text-[1.1rem] lg:text-[1.2rem] text-opacity-70 line-clamp-3">
